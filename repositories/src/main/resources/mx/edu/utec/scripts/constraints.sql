...
ALTER TABLE PERIODOALUMNO ADD CONSTRAINT FK8909254 FOREIGN KEY(CUATRIMESTRE_ID) REFERENCES CUATRIMESTRE(ID) NOCHECK;
...
ALTER TABLE USER ADD CONSTRAINT FK89092514 FOREIGN KEY(PERSONAL_ID) REFERENCES PERSONAL(ID) NOCHECK;
